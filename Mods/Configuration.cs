    ...
    internal class Configuration
    {
        public static void ChangePlayerSpeed()
        {
            ...
            if (Variables.speedChanger == 0)
            {
                ...
                Buttons.buttons[12][1].buttonText = "Change Player Speed [6.5]";
                Buttons.buttons[12][1].overlapText = "Change Player Speed [6.5]";
            }
            else if (Variables.speedChanger == 1)
            {
                Variables.playerSpeed = 8f;
                Variables.playerMult = 1.35f;
                Buttons.buttons[12][1].buttonText = "Change Player Speed [8]";
                Buttons.buttons[12][1].overlapText = "Change Player Speed [8]";
            }
            else if (Variables.speedChanger == 2)
            {
                Variables.playerSpeed = 10f;
                Variables.playerMult = 1.585f;
                Buttons.buttons[12][1].buttonText = "Change Player Speed [10]";
                Buttons.buttons[12][1].overlapText = "Change Player Speed [10]";
            }
            else if (Variables.speedChanger == 3)
            {
                Variables.playerSpeed = 12f;
                Variables.playerMult = 1.75f;
                Buttons.buttons[12][1].buttonText = "Change Player Speed [12]";
                Buttons.buttons[12][1].overlapText = "Change Player Speed [12]";
        ...
        public static void ChangeFlySpeed()
        {
            ...
            if (Variables.flyChanger == 0)
            {
                ...
                Buttons.buttons[12][2].buttonText = "Fly Speed [8.5]";
                Buttons.buttons[12][2].overlapText = "Fly Speed [8.5]";
            }
            else if (Variables.flyChanger == 1)
            {
                Variables.flySpeed = 10f;
                Buttons.buttons[12][2].buttonText = "Fly Speed [10]";
                Buttons.buttons[12][2].overlapText = "Fly Speed [10]";
            }
            else if (Variables.flyChanger == 2)
            {
                Variables.flySpeed = 15f;
                Buttons.buttons[12][2].buttonText = "Fly Speed [15]";
                Buttons.buttons[12][2].overlapText = "Fly Speed [15]";
            }
            else if (Variables.flyChanger == 3)
            {
                Variables.flySpeed = 20f;
                Buttons.buttons[12][2].buttonText = "Fly Speed [20]";
                Buttons.buttons[12][2].overlapText = "Fly Speed [20]";
        ...
        public static void ChangeArmSize()
        {
            ...
            if (Variables.armsizeChanger == 0)
            {
                ...
                Buttons.buttons[12][4].buttonText = "Arm Size [1]";
                Buttons.buttons[12][4].overlapText = "Arm Size [1]";
            }
            else if (Variables.armsizeChanger == 1)
            {
                Variables.armSize = 1.2f;
                Buttons.buttons[12][4].buttonText = "Arm Size [1.2]";
                Buttons.buttons[12][4].overlapText = "Arm Size [1.2]";
            }
            else if (Variables.armsizeChanger == 2)
            {
                Variables.armSize = 1.4f;
                Buttons.buttons[12][4].buttonText = "Arm Size [1.4]";
                Buttons.buttons[12][4].overlapText = "Arm Size [1.4]";
            }
            else if (Variables.armsizeChanger == 3)
            {
                Variables.armSize = 1.6f;
                Buttons.buttons[12][4].buttonText = "Arm Size [1.6]";
                Buttons.buttons[12][4].overlapText = "Arm Size [1.6]";
            }
            else if (Variables.armsizeChanger == 4)
            {
                Variables.armSize = 1.8f;
                Buttons.buttons[12][4].buttonText = "Arm Size [1.8]";
                Buttons.buttons[12][4].overlapText = "Arm Size [1.8]";
            }
            else if (Variables.armsizeChanger == 5)
            {
                Variables.armSize = 2f;
                Buttons.buttons[12][4].buttonText = "Arm Size [2]";
                Buttons.buttons[12][4].overlapText = "Arm Size [2]";
        ...
        public static void ChangeMenuThemeV2()
        {
            ...
            {
                Settings.isMonkeMaterial = false;
                ...
                Buttons.buttons[1][1].buttonText = "Change Menu Theme [DEFAULT]";
                Buttons.buttons[1][1].overlapText = "Change Menu Theme [DEFAULT]";
            }
            else if (CurrentTheme == 1) // PURPLE PINK
            {
                ...
                Buttons.buttons[1][1].buttonText = "Change Menu Theme [PURPLE]";
                Buttons.buttons[1][1].overlapText = "Change Menu Theme [PURPLE]";
            }
            else if (CurrentTheme == 2) //BLUE GREY
            {
                ...
                Buttons.buttons[1][1].buttonText = "Change Menu Theme [BLUE]";
                Buttons.buttons[1][1].overlapText = "Change Menu Theme [BLUE]";
            }
            else if (CurrentTheme == 3) // PINK
            {
                ...
                Buttons.buttons[1][1].buttonText = "Change Menu Theme [PINK]";
                Buttons.buttons[1][1].overlapText = "Change Menu Theme [PINK]";
            }
            else if (CurrentTheme == 4) // MINTY
            {
                ...
                Buttons.buttons[1][1].buttonText = "Change Menu Theme [MINT]";
                Buttons.buttons[1][1].overlapText = "Change Menu Theme [MINT]";
            }
            else if (CurrentTheme == 5) // MAGENTA
            {
                ...
                Buttons.buttons[1][1].buttonText = "Change Menu Theme [MAGENTA]";
                Buttons.buttons[1][1].overlapText = "Change Menu Theme [MAGENTA]";
            }
            else if (CurrentTheme == 6) // ORANGE
            {
                ...
                Buttons.buttons[1][1].buttonText = "Change Menu Theme [ORANGE]";
                Buttons.buttons[1][1].overlapText = "Change Menu Theme [ORANGE]";
            }
            else if (CurrentTheme == 7) // TERRICOTTA
            {
                Settings.MenuColor = new Color32(222, 196, 169, 1);
                Variables.ButtonDisabled = new Color32(194, 171, 147, 1);
                Variables.ButtonEnabled = new Color32(217, 199, 180, 1);
                Settings.SideButtonsColor = new Color32(222, 196, 169, 1);
                Settings.OutlineColor = new Color32(130, 130, 130, 1);
                Buttons.buttons[1][1].buttonText = "Change Menu Theme [TERRAIN]";
                Buttons.buttons[1][1].overlapText = "Change Menu Theme [TERRAIN]";
                CurrentTheme = -1;
            }
            Main.RecreateMenu();
        }
        ...
        public static void ChangeButtonSoundType()
        {
            ...
            if (Variables.buttonSoundChanger == 1)
            {
                ...
                Buttons.buttons[1][3].buttonText = "Button Sound Changer [100]";
                Buttons.buttons[1][3].overlapText = "Button Sound Changer [100]";
            }
            if (Variables.buttonSoundChanger == 2)
            {
                Variables.buttonIndex = 66;
                Buttons.buttons[1][3].buttonText = "Button Sound Changer [66]";
                Buttons.buttons[1][3].overlapText = "Button Sound Changer [66]";
            }
            if (Variables.buttonSoundChanger == 3)
            {
                Variables.buttonIndex = 135;
                Buttons.buttons[1][3].buttonText = "Button Sound Changer [135]";
                Buttons.buttons[1][3].overlapText = "Button Sound Changer [135]";
            }
            if (Variables.buttonSoundChanger == 4)
            {
                Variables.buttonIndex = 3;
                Buttons.buttons[1][3].buttonText = "Button Sound Changer [3]";
                Buttons.buttons[1][3].overlapText = "Button Sound Changer [3]";
            }
            if (Variables.buttonSoundChanger == 5)
            {
                Variables.buttonIndex = 45;
                Buttons.buttons[1][3].buttonText = "Button Sound Changer [45]";
                Buttons.buttons[1][3].overlapText = "Button Sound Changer [45]";
            }
            if (Variables.buttonSoundChanger == 6)
            {
                Variables.buttonIndex = 67;
                Buttons.buttons[1][3].buttonText = "Button Sound Changer [67]";
                Buttons.buttons[1][3].overlapText = "Button Sound Changer [67]";
            }
            if (Variables.buttonSoundChanger == 7)
            {
                Variables.buttonIndex = 71;
                Buttons.buttons[1][3].buttonText = "Button Sound Changer [71]";
                Buttons.buttons[1][3].overlapText = "Button Sound Changer [71]";
            }
            if (Variables.buttonSoundChanger == 8)
            {
                Variables.buttonIndex = 84;
                Buttons.buttons[1][3].buttonText = "Button Sound Changer [84]";
                Buttons.buttons[1][3].overlapText = "Button Sound Changer [84]";
            }
            if (Variables.buttonSoundChanger == 9)
            {
                Variables.buttonIndex = 51;
                Buttons.buttons[1][3].buttonText = "Button Sound Changer [51]";
                Buttons.buttons[1][3].overlapText = "Button Sound Changer [51]";
            }
            if (Variables.buttonSoundChanger == 10)
            {
                Variables.buttonIndex = 37;
                Buttons.buttons[1][3].buttonText = "Button Sound Changer [37]";
                Buttons.buttons[1][3].overlapText = "Button Sound Changer [37]";
            }
            if (Variables.buttonSoundChanger == 11)
            {
                Variables.buttonIndex = 43;
                Buttons.buttons[1][3].buttonText = "Button Sound Changer [43]";
                Buttons.buttons[1][3].overlapText = "Button Sound Changer [43]";
            }
            if (Variables.buttonSoundChanger == 12)
            {
                Variables.buttonIndex = 4;
                Buttons.buttons[1][3].buttonText = "Button Sound Changer [4]";
                Buttons.buttons[1][3].overlapText = "Button Sound Changer [4]";
            }
            Main.RecreateMenu();
        }
        ...
        public static void ChangeSlideControlControl()
        {
            ...
            {
                Variables.slideControl = int.MaxValue;
                Buttons.buttons[12][3].buttonText = "Slide Control Strength [255]";
                Buttons.buttons[12][3].overlapText = "Slide Control Strength [255]";
            }
            if (Variables.slideSpeed == 2)
            {
                Variables.slideControl = 75;
                Buttons.buttons[12][3].buttonText = "Slide Control Strength [75]";
                Buttons.buttons[12][3].overlapText = "Slide Control Strength [75]";
            }
            if (Variables.slideSpeed == 3)
            {
                Variables.slideControl = 50;
                Buttons.buttons[12][3].buttonText = "Slide Control Strength [50]";
                Buttons.buttons[12][3].overlapText = "Slide Control Strength [50]";
            }
        }
    }
}

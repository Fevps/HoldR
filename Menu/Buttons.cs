    ...
    internal class Buttons
    {
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            new ButtonInfo[] { // Main Mods [0]
                ...
                new ButtonInfo { buttonText = "Safety Mods", method =() => SettingsMods.SafetySettings(), isTogglable = false, toolTip = "Opens the safety settings for the menu.", isCategoryButton = true},
            ...
            new ButtonInfo[] { // Configuration [1]
                new ButtonInfo { buttonText = "Other Mod Configurations", method =() => SettingsMods.GameModeMods(), isTogglable = false, isCategoryButton = false},
                new ButtonInfo { buttonText = "Change Menu Theme [DEFAULT]", method =() => Configuration.ChangeMenuThemeV2(), isTogglable = false, toolTip = "Change Menu Theme."},
                new ButtonInfo { buttonText = "Trigger Pages", method =() => Main.TriggerPages(), disableMethod =() => Main.FixTrigger(), isTogglable = true, toolTip = "Lets you use triggers to change pages."},
                ...
                new ButtonInfo { buttonText = "Button Sound Changer [100]", method =() => Configuration.ChangeButtonSoundType(), isTogglable = false, toolTip = "Change Button Sound Type."},
            ...
            new ButtonInfo[] { // Room Settings [2]
                ...
                new ButtonInfo { buttonText = "Bypass Bad Name [W?]", method =() => OtherMods.BadNameBypasser(), isTogglable = true},
                ...
                new ButtonInfo { buttonText = "Disable Voice Chat", method =() => PlayerPrefs.GetString("voiceChatOn", "FALSE"), disableMethod =() => PlayerPrefs.GetString("voiceChatOn", "TRUE"), isTogglable = true},

                new ButtonInfo { buttonText = "Regional Mod Category", method =() => SettingsMods.RegionalSettings(), isTogglable = false, toolTip = "Opens a tab of region mods."},
            },

            new ButtonInfo[] { // Miscellaneous [3]
            ...
            new ButtonInfo[] { // Movement Settings [4]
                new ButtonInfo { buttonText = "Platforms <color=gray>[</color>G<color=gray>]</color>", method =() => Movement.Plattys(Variables.ButtonDisabled), isTogglable = true, toolTip = "Platforms, left and right grip to activate platforms."},
                new ButtonInfo { buttonText = "Drop Platforms <color=gray>[</color>G<color=gray>]</color>", method =() => Movement.ThrowPlattys(Variables.ButtonDisabled), isTogglable = true, toolTip = "Platforms, left and right grip to activate platforms."},
                ...
                new ButtonInfo { buttonText = "Rig Gun", method =() => Functions.RigGun(), isTogglable = true, toolTip = "Disables your rig and transforms it to your pointer."},

                //new ButtonInfo { buttonText = "Sex Gun", method =() => Movement.SexGun(), isTogglable = true},

                new ButtonInfo { buttonText = "Helicopter <color=grey>[</color>A<color=grey>]</color>", method =() => Functions.Helicopter(), disableMethod =() => Functions.FixRig(), isTogglable = true, toolTip = "Helicopter monkey, use primary to activate."},
            ...
            new ButtonInfo[] { // Overpowered Mods [5]
                ...
                //new ButtonInfo { buttonText = "Unban", method =() => Main.unban = true},

                new ButtonInfo { buttonText = "Tag Self", method =() => OtherMods.InfectSelf(), disableMethod =() => OtherMods.FixSelf(), isTogglable = true, toolTip = "Hold on for 2 seconds and then turn off."},
                new ButtonInfo { buttonText = "Tag Aura", method =() => OtherMods.TagAura(), isTogglable = true},
                new ButtonInfo { buttonText = "Tag Gun [<color=red>EXPERIMENTAL</color>]", method =() => OtherMods.InfectGun(), disableMethod =() => OtherMods.FixSelf(), isTogglable = true},
                new ButtonInfo { buttonText = "Tag All", method =() => OtherMods.InfectAll(), disableMethod =() => OtherMods.FixSelf(), isTogglable = true},

                new ButtonInfo { buttonText = "Annoy All", method =() => Movement.AnnoyRandomPlayer(), isTogglable = true},

                new ButtonInfo { buttonText = "Grab Glider [SS] [SKY]", method =() => OtherMods.GrabAGlider(), isTogglable = true, toolTip = "Grab a glider."},
                new ButtonInfo { buttonText = "Grab All Gliders [SS] [SKY]", method =() => OtherMods.GrabEveryGlider(), isTogglable = true},
                new ButtonInfo { buttonText = "Glider All [SS] [SKY]", method =() => OtherMods.GliderAll1(), isTogglable = true, toolTip = "Everyone grab a glider."},
                new ButtonInfo { buttonText = "Spaz Every Glider [SS] [SKY]", method =() => OtherMods.SpamAllGliders(), isTogglable = true},
                new ButtonInfo { buttonText = "Float Gliders [SS] [SKY]", method =() => OtherMods.FloatGliders(), isTogglable = true},
                new ButtonInfo { buttonText = "Respawn Gliders [NW] [SS] [SKY]", method =() => OtherMods.RespawnGliders(), isTogglable = false, toolTip = "Resets every active and non-active glider."},
            ...
            new ButtonInfo[] { // Visual Mods [6]
                new ButtonInfo { buttonText = "Enable Infection Visuals", method =() => Visuals.isRainbowVisuals = true, disableMethod =() => Visuals.isRainbowVisuals = false, isTogglable = true, enabled = true, toolTip = "Turns visuals to rainbow."},
                ...
                new ButtonInfo { buttonText = "Bread Crumb ESP", method =() => Visuals.BreadCrumbVisuals(), isTogglable = true, toolTip = "Activates esp for the entire lobby."},
                new ButtonInfo { buttonText = "Snake ESP", method =() => Visuals.SnakeVisuals(), isTogglable = true, toolTip = "Activates esp for the entire lobby."},

                new ButtonInfo { buttonText = "Gear Changer [NONE]", method =() => Cosmetics.BadgeChanger(), isTogglable = false},
                ...
                //new ButtonInfo { buttonText = "Wear An Gauntlet", method =() => Visuals.Gauntlet(), isTogglable = true},
            ...
            new ButtonInfo[] { // Safety [7]
                new ButtonInfo { buttonText = "Antireport [FOREST]", method =() => AntiReport.AntiReports(), isTogglable = true},
                ...
                new ButtonInfo { buttonText = "Anti-Mod Checker [NULL]", method =() => Functions.AntiModChecker(), isTogglable = false, toolTip = "Disables your mods from an hashtable, making your mod properties null."},
                new ButtonInfo { buttonText = "Anti-Mod Checker [NUKE]", method =() => Functions.NukeModChecker(), isTogglable = false, toolTip = "Disables your mods from an hashtable, making your mod properties arabic, breaking their checker."},
            ...
            new ButtonInfo[] { // Player Mods [8]
                ...
                new ButtonInfo { buttonText = "Spaz Monkey", method =() => Functions.SpazMonkey(), isTogglable = true, toolTip = "Spazzes your rig fast until you disable the mod."},
                ...
                //new ButtonInfo { buttonText = "Look At Random", method =() => PlayerMods.LookAtRandom(), disableMethod =() => Functions.FixHead(), isTogglable = true},
                //new ButtonInfo { buttonText = "Look At Everyone", method =() => PlayerMods.SpazHeadAtEveryone(), isTogglable = true},
            ...
            new ButtonInfo[] { // Other Player Mods [10]
            ...
            /*new ButtonInfo[] { // Game Mod Mods [Overpowered] [NULL]
            ...
            new ButtonInfo[] { // Mods Configuration [IN CONFIG] [12]
                new ButtonInfo { buttonText = "Go Back", method =() => SettingsMods.EnterSettings(), isTogglable = false, isCategoryButton = true},
                new ButtonInfo { buttonText = "Movement Speed [6.5]", method =() => Configuration.ChangePlayerSpeed(), isTogglable = false, toolTip = "Change Player Speed."},
                new ButtonInfo { buttonText = "Fly Speed [8.5]", method =() => Configuration.ChangeFlySpeed(), isTogglable = false, toolTip = "Change Fly Speed."},
                new ButtonInfo { buttonText = "Slide Control Strength [255]", method =() => Configuration.ChangeSlideControlControl(), isTogglable = false, toolTip = "Changes Players Slide Control."},
                new ButtonInfo { buttonText = "Arm Size [1]", method =() => Configuration.ChangeArmSize(), isTogglable = false, toolTip = "Change Arm Size."},
            },

            new ButtonInfo[] { // Regional Configuration [IN ROOM] [13]
                new ButtonInfo { buttonText = "Go Back", method =() => SettingsMods.RoomSettings(), isTogglable = false, toolTip = "Opens the room settings page for the menu.", isCategoryButton = true},
